...
| ----------- | ----------- | ------------- | ------ |
| `data`      | `ChartDataPoint[]` | Yes* | Data for the chart. Overrides optional data provided in `<Chart />`.  |
| `theme`   | Defined below        | |  |
...
```jsx
import { Chart, HorizontalAxis, Area, VerticalAxis, Line } from 'react-native-responsive-linechart'
