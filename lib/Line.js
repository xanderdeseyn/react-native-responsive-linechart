        ...
        React.createElement(react_native_svg_1.G, { translateX: viewportOrigin.x, translateY: viewportOrigin.y },
            ...
            points.map(function (p, i) {
                ...
                if (props.pointIcon !== undefined) {
                    return (React.createElement(react_native_svg_1.ForeignObject, { x: p.x - 10 + shape.dx, y: p.y - 10 - shape.dy }, React.cloneElement(pointIcon, { width: 20, height: 20 })));
                }
                else {
