...
var Line = React.forwardRef(function Line(props, ref) {
    ...
    var _c = React.useState(props.alwaysShowAllToolTips), alwaysShowAllToolTips = _c[0], setalwaysShowAllToolTips = _c[1];
    var _d = deepmerge_1.default(defaultProps, props), _e = _d.theme, stroke = _e.stroke, scatter = _e.scatter, tooltipComponent = _d.tooltipComponent, _f = _d.data, data = _f === void 0 ? contextData : _f, tension = _d.tension, smoothing = _d.smoothing, onTooltipSelect = _d.onTooltipSelect, hideTooltipOnDragEnd = _d.hideTooltipOnDragEnd, hideTooltipAfter = _d.hideTooltipAfter, _g = _d.onTooltipSelectEnd, onTooltipSelectEnd = _g === void 0 ? function () { } : _g;
    if (!dimensions) {
        return null;
    }
    ...
    return (React.createElement(React.Fragment, null,
        ...
        alwaysShowAllToolTips && data.map(function (value, index) {
